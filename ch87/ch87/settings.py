"""
Django settings for ch87 project.
...
SECRET_KEY = 'django-insecure-261gb*wj^93t8da(*)+t%uaipw*p-e3z-m7ib5tuzka^(^71z_'
...
WSGI_APPLICATION = 'ch87.wsgi.application'
