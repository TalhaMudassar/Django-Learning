"""
Django settings for ch90 project.
...
SECRET_KEY = 'django-insecure-es3mlzkh_k-cjlv-4cq3+27uzxh5tkz8*f$p4x1jc$0-(l1qj-'
...
WSGI_APPLICATION = 'ch90.wsgi.application'
