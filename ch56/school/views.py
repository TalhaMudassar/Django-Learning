...
#  all_data = Student.objects.all()
    ...
    # all_data = Student.objects.filter(city="hasilpur")
    # all_data = Student.objects.exclude(city="hasilpur")
...
#     all_data = Student.objects.values_list('id', 'name')    #it shows tuple 
...
#     qs1 = Student.objects.values_list('id', 'name', named=True)
#     qs2 = Teacher.objects.values_list('id', 'name', named=True)
#     all_data = qs2.union(qs1, all=True)  # all=True duplicate allows 
